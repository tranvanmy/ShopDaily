          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo url('public/admin/images/img.jpg'); ?>" alt="..." class="img-circle profile_img">
              </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo e(action('CategoryController@index')); ?>">Category</a></li>
                      <li><a href="<?php echo e(action('ColorController@index')); ?>">Color</a></li>
